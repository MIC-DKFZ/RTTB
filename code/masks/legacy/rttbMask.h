...
//      Mask( DoseIteratorInterface* aDoseIter  , const std::vector<legacy::DoseVoxel>& aDoseVoxelVector );
      ...
      */
      bool GetIntersectionsOfSliceForTest( unsigned int position , PolygonInTermsOfIntersections& Polygon_Intersections_Ref );
      ...
      */     
      bool TestGoIntersectColumnByComparisonWithExpectedResult( LegacyWorldCoordinate3D firstPoint , LegacyWorldCoordinate3D secondPoint , std::vector<LegacyWorldCoordinate2D>& column_intersections_ref, std::vector<LegacyWorldCoordinate2D>& expected_intersections_ref );
      ...
      */          
      bool TestGoIntersectRawByComparisonWithExpectedResult( LegacyWorldCoordinate3D firstPoint , LegacyWorldCoordinate3D secondPoint , std::vector<LegacyWorldCoordinate2D>& raw_intersections_ref, std::vector<LegacyWorldCoordinate2D>& expected_intersections_ref );
      ...
      */           
      bool IdenticalIntersectionsForTest( std::vector<LegacyWorldCoordinate2D>& calculated_intersections_ref , std::vector<LegacyWorldCoordinate2D>& expected_intersections_ref );
      ...
      */              
      bool CheckFractionThisVoxelCorrectForTest( LegacyDoseVoxelIndex3D another_dose_index , float the_correct_result );
    ...
    protected:
      ...
      */          
      void CheckUppwardBlockSameIntensity( int resolution_level_in , LegacyUnsignedIndex3D index_internal , int brightness ); 
      ...
      */  
      void SetUppwardBlockThisIntensity( int resolution_level_in , LegacyUnsignedIndex3D index_internal , int brightness );  
      /*! @brief This function is made for assertation. The voxelization is done on several resultution levels as explained above. 
          ...
          @param brightness Integer that specifies the brightness that is expected throughout all the finer resolution levels.                    
      */  
      void CheckUppwardOneOutOfThisBlockHasSameIntensity( int resolution_level_in , LegacyUnsignedIndex3D index_internal , int brightness );      
      ...
      */  
      bool HasIntersectionsThisPair(  const LegacyWorldCoordinate3D& firstPoint ,  const LegacyWorldCoordinate3D& secondPoint,  const LegacyWorldCoordinate3D& thirdPoint ,  const LegacyWorldCoordinate3D& fourthPoint  ) const;          
    ...
    rttb::masks::legacy::FieldOfPointer<VoxelIntersectionsVectorPointer>* FieldOfIntersections; 
      ...
      */     
      std::vector<StructureInTermsOfIntersections> Intersections; ///Holds the information about the structure and its Intersections with the voxel edges.
      ...
      */  
      ...
      /*! @brief Old Stuff.
      */  
      void ConnectArea( field_content_type brightness_from , field_content_type brightness_to , LegacyUnsignedIndex3D start_index, LegacyDoseVoxelIndex2D index_begin, LegacyDoseVoxelIndex2D index_end );  // To be called by SetDoseVoxelInStructureVector 
      ...
      */  
      bool GetFirstDifferent( unsigned int& struct_index , unsigned int& point_index , LegacyWorldCoordinate3D compare_point );
      ...
      */  
      bool IsItToBeRegarded( unsigned int struct_index , unsigned int point_index , unsigned int intersect_index , int index_x , int index_y );      
      ...
      */  
      void SetThisIntersectionToCornerOrEdge(unsigned int index_x , unsigned int index_y , IterativePolygonInTermsOfIntersections::WhichIntersection intersection , LegacyWorldCoordinate2D coord2D, unsigned int edge_number, IntersectionsThisVoxel& voxel_intersections );
      ...
      */  
      void SetThisIntersection( unsigned int corner_of_interest, unsigned int corner_next , unsigned int corner_fixed ,  IterativePolygonInTermsOfIntersections::WhichIntersection intersection , double coord_of_interest , double coord_fixed, IntersectionsThisVoxel& voxel_intersections , unsigned int edge_number );
      ...
      */  
      bool CompareIfBetweenAppend( double value_to_compare , double small_value_to_compare_with , double big_value_to_compare_with, unsigned int edge_number, IterativePolygonInTermsOfIntersections::WhichIntersection intersection , IntersectionsThisVoxel& voxel_intersections ); 
      ...
      */  
      bool CheckIfIndenticalOrBetweenRespectiveVectorElementsAndDoInsert( double value_to_compare , unsigned int edge_number, IterativePolygonInTermsOfIntersections::WhichIntersection intersection , IntersectionsThisVoxel& voxel_intersections );      
      ...
      */  
      bool CompareIfBetweenInsertAtBeginning( double value_to_compare , double small_value_to_compare_with , double big_value_to_compare_with, unsigned int edge_number, IterativePolygonInTermsOfIntersections::WhichIntersection intersection , IntersectionsThisVoxel& voxel_intersections );      
      
      
      /*! @brief  Old stuff.
      */  
      void SetThisIntersectionXIncreasing( unsigned int index_x , unsigned int index_y ,  IterativePolygonInTermsOfIntersections::WhichIntersection intersection , LegacyWorldCoordinate2D coord2D , IntersectionsThisVoxel& voxel_intersections , unsigned int edge_number );  
      /*! @brief Old stuff.
      */  
      void SetThisIntersectionYIncreasing(unsigned int index_x , unsigned int index_y , IterativePolygonInTermsOfIntersections::WhichIntersection intersection , LegacyWorldCoordinate2D coord2D , IntersectionsThisVoxel& voxel_intersections );
      /*! @brief Old stuff.
      */  
      void SetThisIntersectionXDecreasing(unsigned int index_x , unsigned int index_y ,  IterativePolygonInTermsOfIntersections::WhichIntersection intersection , LegacyWorldCoordinate2D coord2D , IntersectionsThisVoxel& voxel_intersections );
      /*! @brief Old stuff.
      */  
      void SetThisIntersectionYDecreasing(unsigned int index_x , unsigned int index_y , IterativePolygonInTermsOfIntersections::WhichIntersection intersection , LegacyWorldCoordinate2D coord2D , IntersectionsThisVoxel& voxel_intersections );
      ...
      */  
      void UnifyRawAndColumn( LegacyWorldCoordinate3D firstPoint, std::vector<LegacyWorldCoordinate2D>& raw_intersections_ref , std::vector<LegacyWorldCoordinate2D>& column_intersections_ref ,  std::vector<LegacyWorldCoordinate2D>& intersections_raw_and_column_ref, int resolution_level );      
      ...
      */  
      void GoIntersectRaw( LegacyWorldCoordinate3D firstPoint , LegacyWorldCoordinate3D secondPoint , std::vector<LegacyWorldCoordinate2D>& raw_intersections_ref , int resolution_level );
      ...
      /*! @brief  This function calculates the intersections between a line and the vertical voxel edges (voxel edges in column direction). 
          ...
          @param  resolution_level The current resolution.                                                  
      */  
      void GoIntersectColumn( LegacyWorldCoordinate3D firstPoint , LegacyWorldCoordinate3D secondPoint , std::vector<LegacyWorldCoordinate2D>& column_intersections_ref, int resolution_level  );
      ...
      /*! @brief This function calculates the intersections between a line and the horizontal voxel edges (voxel edges in raw direction). 
          ...
          @param  resolution_level The current resolution.                   
      */  
      void GoGetRawIntersectionsAlongThisColumn( LegacyWorldCoordinate3D firstPoint , LegacyWorldCoordinate3D secondPoint , std::vector<LegacyWorldCoordinate2D>& raw_intersections_ref, int resolution_level  );       
      ...
      /*! @brief  This function calculates the intersections between a line and the vertical voxel edges (voxel edges in column direction). 
          ...
          @param  resolution_level The current resolution.                                                  
      */  
      void GoGetColumnIntersectionsAlongThisRaw( LegacyWorldCoordinate3D firstPoint , LegacyWorldCoordinate3D secondPoint , std::vector<LegacyWorldCoordinate2D>& column_intersections_ref, int resolution_level );	
      ...
      */  
      void AddToFieldOfIntersections( unsigned int index_x , unsigned int index_y , unsigned int index_z , unsigned int struct_index , unsigned int point_index , unsigned int intersect_index , LegacyWorldCoordinate2D coord2D, unsigned int voxel_side );      
      ...
      */  
      void ExtendFieldOfIntersections( unsigned int index_x , unsigned int index_y , unsigned int index_z , unsigned int struct_index );
      ...
      */  
      int GetRespectiveIntersections( unsigned int index_x , unsigned int index_y , unsigned int index_z , unsigned int struct_index ) const;
      ...
      */  
      void setInsideVoxel( int resolution_level, std::vector< UnsignedIndexList > indexListInside, std::vector< UnsignedIndexList > indexListOutside );
