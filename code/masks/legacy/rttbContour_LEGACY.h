    ...
    */
    ...
    private:
      ...
      */
      ...
      static double multiply(const LegacyWorldCoordinate3D& p1,const LegacyWorldCoordinate3D& p2, const LegacyWorldCoordinate3D& p0);

      static LegacyWorldCoordinate2D calcInterPoint2D(const LegacyWorldCoordinate2D& p1, const LegacyWorldCoordinate2D& p2, const LegacyWorldCoordinate2D& q1, const LegacyWorldCoordinate2D& q2); 
    ...
    public:
      ...
      */
      static LegacyWorldCoordinate3D calcInterPoint(const LegacyWorldCoordinate3D& p1, const LegacyWorldCoordinate3D& p2, const LegacyWorldCoordinate3D& q1, const LegacyWorldCoordinate3D& q2);

      /*! @brief Tests if an intersection exists between two segments (p1, p2) and (q1, q2) */          
      static bool intersect(const LegacyWorldCoordinate3D& p1, const LegacyWorldCoordinate3D& p2, const LegacyWorldCoordinate3D& q1, const LegacyWorldCoordinate3D& q2);           
