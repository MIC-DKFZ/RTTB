			...
			*/
			...
			public:
				...
				*/
				...
				//same method with legacy data structures
				void setDoseVoxel(const LegacyDoseVoxelIndex3D& aDoseIndex,
				...
				*/
				...
				std::vector<WorldCoordinate3D> calcIntersectionPoints(WorldCoordinate3D firstPoint,
				        WorldCoordinate3D secondPoint);
				//same method with legacy data structures
				std::vector<LegacyWorldCoordinate3D> calcIntersectionPoints(LegacyWorldCoordinate3D firstPoint,
