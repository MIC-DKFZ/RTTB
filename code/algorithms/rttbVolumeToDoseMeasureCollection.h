...
namespace rttb
{
	...
	namespace algorithms
	{
      ...
      complexStatistics _name;
		...
		RTTBAlgorithms_EXPORT bool operator==(const VolumeToDoseMeasureCollection& volumeToDoseMesureCollection, const VolumeToDoseMeasureCollection& otherVolumeToDoseMesureCollection);
	}
}
