			...
			public: 
				...
				*/
				...
				/*! @brief Volume of one voxel (in cm3)
					...
					@todo inhomogeneous grids are not supported at the moment.
				*/
				...
				/*! Check first if the position inside the maskedVoxelVector is valid. If so, check if the gridID at the 
					...
					@todo: Equality of grids needs to be further defined to determine if checking one grid is sufficient.
				*/
