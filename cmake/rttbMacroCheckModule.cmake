# Usage: RTTB_CHECK_MODULE(RESULT_VAR [dependencies ...] )
# check if all required modules exist and stores missing module names in RESULT_VAR.
MACRO(RTTB_CHECK_MODULE RESULT_VAR)
  SET(${RESULT_VAR} "")
  SET(DEPENDS "")
  ...
  FILE(GLOB _ALL_MODULES RELATIVE ${RTTB_MODULES_CONF_DIR} ${RTTB_MODULES_CONF_DIR}/*Config.cmake)
