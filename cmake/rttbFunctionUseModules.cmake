function(_rttb_parse_package_args)
...
function(_include_package_config pkg_config_file)
  # wrap the inclusion of the RTTB_<pkg>_Config.cmake file in a
...
#! depends on a set of RTTB modules or packages.
#!
...
function(rttb_use_modules)
    ...
    foreach(dependency ${depends})
      if(TARGET ${dependency} AND NOT MODULE_IS_DEPRECATED)
        ...
        if(NOT _is_interface_lib)
          get_target_property(_dependency_deprecated_since ${dependency} RTTB_MODULE_DEPRECATED_SINCE)
  ...
  if(package_depends)
    _rttb_parse_package_args(${package_depends})

    # Some package config files rely on a
    ...
    foreach(_package_visibility INTERFACE PUBLIC PRIVATE)
      foreach(_package ${${_package_visibility}_PACKAGE_NAMES})
        ...
        foreach(dir ${MODULES_PACKAGE_DEPENDS_DIRS})
          if((NOT DEFINED RTTB_USE_${_package} OR RTTB_USE_${_package}) AND EXISTS "${dir}/RTTB_${_package}_Config.cmake")
            _include_package_config("${dir}/RTTB_${_package}_Config.cmake")
