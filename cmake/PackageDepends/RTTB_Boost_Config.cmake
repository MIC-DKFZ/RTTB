...
SET(_RTTB_Boost_REQUIRED_COMPONENTS_BY_MODULE ${Boost_REQUIRED_COMPONENTS_BY_MODULE} ${RTTB_Boost_ADDITIONAL_COMPONENT})

SET(_RTTB_Boost_FIND_COMPONENTS ${_RTTB_Boost_REQUIRED_COMPONENTS_BY_MODULE})
LIST(REMOVE_ITEM _RTTB_Boost_FIND_COMPONENTS "headers")
FIND_PACKAGE(Boost ${BOOST_MIN_VERSION} REQUIRED COMPONENTS ${_RTTB_Boost_FIND_COMPONENTS} QUIET)

if(_RTTB_Boost_REQUIRED_COMPONENTS_BY_MODULE)
  foreach(boost_component ${_RTTB_Boost_REQUIRED_COMPONENTS_BY_MODULE})
