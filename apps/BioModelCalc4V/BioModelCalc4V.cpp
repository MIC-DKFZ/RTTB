...
#include "../BioModelCalc/BioModelCalcApplicationData.h"
#include "../BioModelCalc/BioModelCalcHelper.h"
#include "../BioModelCalc/BioModelCmdLineParser.h"
#include "../DoseTool4V/DoseTool4VHelper.h"
...
int main(int argc, const char** argv)
{
	...
	const std::string appName = "BioModelCalc4V";
	const std::string appDesc = "An App to calculate the Linear quadratic (LQ) BioModel with virtuos support. The GUI for this app is currently under development and in an experimental state.";
	...
	try
	{
		appData._dose = rttb::apps::doseTool4V::loadDose(appData._doseFileName, appData._doseLoadStyle);
