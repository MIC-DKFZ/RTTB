...
#include "../DoseAcc/DoseAccApplicationData.h"
#include "../DoseAcc/DoseAccHelper.h"
#include "../DoseAcc/DoseAccCmdLineParser.h"
...
int main(int argc, const char** argv)
{
    ...
    try
    {
        appData._dose1 = rttb::apps::doseTool4V::loadDose(appData._dose1FileName, appData._dose1LoadStyle);
    }
    ...
    try
    {
        appData._dose2 = rttb::apps::doseTool4V::loadDose(appData._dose2FileName, appData._dose2LoadStyle);
    }
    catch (::itk::ExceptionObject& e)
    {
        std::cerr << "Error!!!" << std::endl;
