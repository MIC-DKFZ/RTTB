...
#include "../DoseTool/DoseToolApplicationData.h"
#include "../DoseTool/DoseToolHelper.h"
#include "../DoseTool/DoseToolCmdLineParser.h"
...
int main(int argc, const char** argv)
{
	...
	if (appData._structLoadStyle.front() != "itk")
	{
		try
		{
			appData._struct = rttb::apps::doseTool4V::loadStruct(appData._structFileName,
