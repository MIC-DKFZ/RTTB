...
namespace rttb{
	...
	namespace testing{
		...
		PolygonType CreateTestStructure::createPolygonLeftUpper(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createPolygonCenter(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createPolygonBetweenUpperLeftAndCenter(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createPolygonBetweenLowerRightAndCenter(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createPolygonLeftEdgeMiddle(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createPolygonUpperCenter(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createPolygonIntermediatePoints(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createPolygonCircle(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createStructureSeveralSectionsInsideOneVoxelA(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createStructureSelfTouchingA(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
		...
		PolygonType CreateTestStructure::createStructureSelfTouchingB(std::vector<VoxelGridIndex2D> aVoxelVector, GridIndexType sliceNumber){
