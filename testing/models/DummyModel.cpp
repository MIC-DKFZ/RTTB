...
namespace rttb{
	namespace models{
		...
		void DummyModel::setParameterVector(const ParamVectorType aParameterVector){
			...
			{
				_param1=aParameterVector.at(0);_setParam1Count++;
				_param2=aParameterVector.at(1);_setParam2Count++;
				_param3=aParameterVector.at(2);_setParam3Count++;
			}
		}
		...
		const int DummyModel::getParameterID(std::string aParamName) const{
