	...
	namespace testing{
		...
		*/
		int BioModelTest(int argc, char* argv[] )
		{
			...
			core::DVH::DVHPointer dvhPtr = boost::make_shared<core::DVH>(aDataDifferential, binSize, voxelVolume, structureID, doseID, voxelizationID);
			...
			CHECK_EQUAL(0,tcplq.getAlpahBeta());
			...
			CHECK_EQUAL(10,tcplq.getAlpahBeta());
			...
			CHECK_EQUAL(8,tcplq.getAlpahBeta());
			...
			CHECK_EQUAL(2,tcplq.getAlpahBeta());
			...
			//Scatter plot tests
			CHECK_NO_THROW(models::getScatterPlotVary1Parameter(tcplq,0,alpha,0,normalizationDose));//variance=0, will be set to 1e-30
			CHECK_THROW_EXPLICIT(models::getScatterPlotVary1Parameter(tcplq,0,alpha,alpha*0.1,0),core::InvalidParameterException);//normalisationdose=0
			CHECK_THROW_EXPLICIT(models::getScatterPlotVary1Parameter(tcplq,0,alpha,alpha*0.1,normalizationDose,10000,0,0),core::InvalidParameterException);//maxDose-minDose=0
