    ...
    namespace doseAcc
    {
      ...
      ParseArgumentsForAppData(int argc, char** argv, ApplicationData& appData)
      {
        ...
        if (appData._showHelp)
        {
          ...
          std::cout <<
                    " DoseCalc dose1.mhd dose2.mhd result.mhd --loadStyle1 itk --loadStyle2 itk -w1 2 -r reg.mapr" <<
                    std::endl << std::endl;
          std::cout <<
                    ...
                    << std::endl << std::endl;
          std::cout <<
                    " DoseCalc dose1.dcm dose2.dos.gz result.mhd --loadStyle2 virtuos dose2.pln -r reg.mapr" <<
                    std::endl << std::endl;
          std::cout <<
